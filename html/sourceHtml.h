...
function showMenu(){var menu=document.getElementById("menu");menu.style.left="0%";var mask=document.getElementById("mask");mask.style.left="0%"}
function onMenuClick(name){var divs=document.getElementsByTagName("div");var menu=document.getElementById("menu");menu.style.left="-100%";var mask=document.getElementById("mask");mask.style.left="-100%";for(var i=0;i<divs.length;i++){if(divs[i].id!=name&&divs[i].id!="menu-button"&&divs[i].id!="wifi"&&divs[i].id!="menu"&&divs[i].id!="mask")
