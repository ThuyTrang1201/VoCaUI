...
function sendData(id){var formData=new FormData();var x=document.getElementById(id);if(x.type=="checkbox"){if(x.checked)formData.append(id,!0);else formData.append(id,!1)}else{formData.append(id,x.value)}
